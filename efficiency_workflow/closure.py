...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--map-type", default="factorized", choices=["factorized", "correlated_3d", "correlated_5d"], help="Correction map type (default: factorized)")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(f"=== {'Factorized' if is_factorized else 'Non-factorized ' + map_type} closure run ===", flush=True)
